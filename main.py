...
def main():
    ...
    # Model and type
    parser.add_argument('--model', type=str, default="babylm/babyllama-10m-2024", help='LLaMA model')
    parser.add_argument('--model_type', type=str, default="llama", help='Model type, either llama or opt')

    # Sampling and sparsity
    parser.add_argument('--seed', type=int, default=0, help='Seed for sampling the calibration data.')
    parser.add_argument('--nsamples', type=int, default=1, help='Number of calibration samples.')  # your value
    parser.add_argument('--sparsity_ratio', type=float, default=0.5, help='Sparsity ratio.')        # your value
    parser.add_argument('--sparsity_type', type=str, default="unstructured", choices=["unstructured", "4:8", "2:4"], help='Sparsity type.')

    # Pruning method
    parser.add_argument('--prune_method', type=str, default="DSnoT", choices=["wanda", "sparsegpt", "magnitude", "DSnoT", "dense"], help='Pruning method')
    parser.add_argument('--initial_method', type=str, default="magnitude", choices=["wanda", "sparsegpt", "magnitude"], help='Initialization method for weights')

    # Eval dataset
    parser.add_argument('--eval_dataset', type=str, default='wikitext2', choices=["wikitext2", "c4", "ptb"], help='Eval ppl on dataset')

    # Optional: model saving and cache
    parser.add_argument('--save_model', type=str, default="50-percent-pruned-babylm-DSnoT", help='Directory to save pruned model')
    parser.add_argument('--cache_dir', type=str, default=r"C:\Users\hp-15\Disc D\scrapeyard\GSCP\pruning\DSNOT2\babylm-10m-weights", help='HuggingFace cache directory')
